 ...
 */
@Entity
@Table(name = "transacciones_det", catalog = "par", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class TransaccionesDet implements Serializable {
    ...
    @JoinColumn(name = "id_transaccion", referencedColumnName = "id_transaccion", nullable = false, insertable = false, updatable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    ...
    public String toString() {
        return "paronlineapi.ec.TransaccionesDet[ transaccionesDetPK=" + transaccionesDetPK + " ]";
    }
